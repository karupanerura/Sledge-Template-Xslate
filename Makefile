# This Makefile is for the Sledge::Template::Xslate extension to perl.
#
...
MAKE = make
FULLEXT = Sledge/Template/Xslate
BASEEXT = Xslate
PARENT_NAME = Sledge::Template
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Sledge/Template/Xslate.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
INST_LIBDIR      = $(INST_LIB)/Sledge/Template
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Sledge/Template
